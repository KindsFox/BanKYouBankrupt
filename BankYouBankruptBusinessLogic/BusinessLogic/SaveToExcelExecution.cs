...
{
    static class SaveToExcelExecution
    {
               ...
               spreadsheetDocument.WorkbookPart.AddNewPart<SharedStringTablePart>();
                ...
                foreach (var cards in info.Cards)
                {
                    InsertCellInWorksheet(new ExcelCellParameters
                    {
                        ...
                        ColumnName = "A",
                        RowIndex = rowIndex,
                        Text = cards.Value.CardsNumder,
                        StyleIndex = 0U
                    });
                    rowIndex++;
                    
                    foreach (var work in cards.Value.Operation)
                    {
                        InsertCellInWorksheet(new ExcelCellParameters
                        {
                            Worksheet = worksheetPart.Worksheet,
                            ...
                            ColumnName = "B",
                            RowIndex = rowIndex,
                            Text = work.Value.Item1.ToString(),
                            StyleIndex = 1U
                        });
                        InsertCellInWorksheet(new ExcelCellParameters
                        {
                            ...
                            ColumnName = "C",
                            RowIndex = rowIndex,
                            Text = work.Value.Item2.ToString(),
                            StyleIndex = 1U
                        });
                        InsertCellInWorksheet(new ExcelCellParameters
                        {
                            ...
                            ColumnName = "D",
                            RowIndex = rowIndex,
                            Text = work.Value.Item3.ToString(),
                            StyleIndex = 1U
                        }); rowIndex++;
                    }
